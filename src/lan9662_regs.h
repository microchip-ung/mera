...
/* This file is autogenerated by cml-utils 2021-05-07 09:00:15 +0000.
 * Commit ID: 42fdb51e58f2d7dacbeb85bb4edbbeb3219f671d
 */
...
#define RTE_TSE_PULSE             __REG(TARGET_RTE,\
					0, 1, 32944, 0, 1, 36, 16, 0, 1, 4)

#define RTE_TSE_PULSE_PULSE_LEN(x)               ((x) & GENMASK(5, 0))
#define RTE_TSE_PULSE_PULSE_LEN_M                GENMASK(5, 0)
#define RTE_TSE_PULSE_PULSE_LEN_X(x)             ((x) & GENMASK(5, 0))

/*      RTE:MISC:PN_MISC */
#define RTE_PN_MISC               __REG(TARGET_RTE,\
					0, 1, 32944, 0, 1, 36, 20, 0, 1, 4)
...
#define RTE_TIME_MISC_CLK_CYCLE_LEN_NS(x)        ((x) & GENMASK(3, 0))
#define RTE_TIME_MISC_CLK_CYCLE_LEN_NS_M         GENMASK(3, 0)
#define RTE_TIME_MISC_CLK_CYCLE_LEN_NS_X(x)      ((x) & GENMASK(3, 0))

/*      RTE:TSE_TIMER_TBL:TSE_TIMER_CFG1 */
#define RTE_TSE_TIMER_CFG1(g)     __REG(TARGET_RTE,\
					0, 1, 33280, g, 32, 16, 0, 0, 1, 4)
...
#define RTE_RTP_GRP_STATE(r)      __REG(TARGET_RTE,\
					0, 1, 32980, 0, 1, 36, 0, r, 9, 4)

/*      RTE:OUTB_MISC:OUTB_CFG */
#define RTE_OUTB_CFG              __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 0, 0, 1, 4)
...
#define RTE_OUTB_TIMER_CMD        __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 4, 0, 1, 4)

#define RTE_OUTB_TIMER_CMD_TIMER_IDX(x)          (((x) << 16) & GENMASK(25, 16))
#define RTE_OUTB_TIMER_CMD_TIMER_IDX_M           GENMASK(25, 16)
#define RTE_OUTB_TIMER_CMD_TIMER_IDX_X(x)        (((x) & GENMASK(25, 16)) >> 16)
...
#define RTE_OUTB_TIMER_HEAP_SIZE  __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 12, 0, 1, 4)

#define RTE_OUTB_TIMER_HEAP_SIZE_WR_TIMER_HEAP_SIZE(x)\
	(((x) << 12) & GENMASK(21, 12))
#define RTE_OUTB_TIMER_HEAP_SIZE_WR_TIMER_HEAP_SIZE_M GENMASK(21, 12)
#define RTE_OUTB_TIMER_HEAP_SIZE_WR_TIMER_HEAP_SIZE_X(x)\
	(((x) & GENMASK(21, 12)) >> 12)

#define RTE_OUTB_TIMER_HEAP_SIZE_RTP_TIMER_HEAP_SIZE(x) ((x) & GENMASK(9, 0))
#define RTE_OUTB_TIMER_HEAP_SIZE_RTP_TIMER_HEAP_SIZE_M GENMASK(9, 0)
#define RTE_OUTB_TIMER_HEAP_SIZE_RTP_TIMER_HEAP_SIZE_X(x) ((x) & GENMASK(9, 0))

/*      RTE:OUTB_MISC:OUTB_WR_ACTION_CMD */
#define RTE_OUTB_WR_ACTION_CMD    __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 16, 0, 1, 4)

#define RTE_OUTB_WR_ACTION_CMD_WR_ACTION_ADDR(x) (((x) << 8) & GENMASK(17, 8))
#define RTE_OUTB_WR_ACTION_CMD_WR_ACTION_ADDR_M  GENMASK(17, 8)
#define RTE_OUTB_WR_ACTION_CMD_WR_ACTION_ADDR_X(x) (((x) & GENMASK(17, 8)) >> 8)
...
#define RTE_OUTB_BUS_ERROR        __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 20, 0, 1, 4)

/*      RTE:OUTB_MISC:OUTB_DG_DATA_ADDR */
#define RTE_OUTB_DG_DATA_ADDR     __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 24, 0, 1, 4)

#define RTE_OUTB_DG_DATA_ADDR_DG_DATA_ADDR(x)    ((x) & GENMASK(11, 0))
#define RTE_OUTB_DG_DATA_ADDR_DG_DATA_ADDR_M     GENMASK(11, 0)
#define RTE_OUTB_DG_DATA_ADDR_DG_DATA_ADDR_X(x)  ((x) & GENMASK(11, 0))

/*      RTE:OUTB_MISC:OUTB_LAST_VLD_DG_DATA_ADDR */
#define RTE_OUTB_LAST_VLD_DG_DATA_ADDR __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 28, 0, 1, 4)

#define RTE_OUTB_LAST_VLD_DG_DATA_ADDR_LAST_VLD_DG_DATA_ADDR(x)\
	((x) & GENMASK(9, 0))
#define RTE_OUTB_LAST_VLD_DG_DATA_ADDR_LAST_VLD_DG_DATA_ADDR_M GENMASK(9, 0)
...
#define RTE_OUTB_DG_DATA_RTP_CTRL_ACC_DG_DATA_RTP_CTRL_ADDR(x)\
	((x) & GENMASK(9, 0))
#define RTE_OUTB_DG_DATA_RTP_CTRL_ACC_DG_DATA_RTP_CTRL_ADDR_M GENMASK(9, 0)
...
#define RTE_OUTB_RTP_STATE(r)     __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 68, r, 17, 4)

/*      RTE:OUTB_MISC:OUTB_DG_DATA_VLD_ACC */
#define RTE_OUTB_DG_DATA_VLD_ACC  __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 136, 0, 1, 4)

#define RTE_OUTB_DG_DATA_VLD_ACC_DG_DATA_VLD_ADDR(x) ((x) & GENMASK(10, 0))
#define RTE_OUTB_DG_DATA_VLD_ACC_DG_DATA_VLD_ADDR_M GENMASK(10, 0)
#define RTE_OUTB_DG_DATA_VLD_ACC_DG_DATA_VLD_ADDR_X(x) ((x) & GENMASK(10, 0))

/*      RTE:OUTB_MISC:OUTB_DG_DBG */
#define RTE_OUTB_DG_DBG           __REG(TARGET_RTE,\
					0, 1, 33016, 0, 1, 148, 140, 0, 1, 4)
...
#define RTE_OUTB_RTP_MISC_WR_ACTION_ADDR(x)      (((x) << 16) & GENMASK(25, 16))
#define RTE_OUTB_RTP_MISC_WR_ACTION_ADDR_M       GENMASK(25, 16)
#define RTE_OUTB_RTP_MISC_WR_ACTION_ADDR_X(x)    (((x) & GENMASK(25, 16)) >> 16)
...
#define RTE_OUTB_RTP_MISC_RTP_GRP_ID(x)          ((x) & GENMASK(8, 0))
#define RTE_OUTB_RTP_MISC_RTP_GRP_ID_M           GENMASK(8, 0)
#define RTE_OUTB_RTP_MISC_RTP_GRP_ID_X(x)        ((x) & GENMASK(8, 0))

/*      RTE:OUTB_RTP_TBL:OUTB_RTP_PDU_CHKS */
#define RTE_OUTB_RTP_PDU_CHKS(g)  __REG(TARGET_RTE,\
					0, 1, 0, g, 513, 64, 8, 0, 1, 4)
...
#define RTE_OUTB_DG_ADDR(g, r)    __REG(TARGET_RTE,\
					0, 1, 0, g, 513, 64, 32, r, 3, 4)

#define RTE_OUTB_DG_ADDR_DG_ADDR(x)              ((x) & GENMASK(9, 0))
#define RTE_OUTB_DG_ADDR_DG_ADDR_M               GENMASK(9, 0)
#define RTE_OUTB_DG_ADDR_DG_ADDR_X(x)            ((x) & GENMASK(9, 0))

/*      RTE:OUTB_RTP_TBL:OUTB_PDU_RECV_CNT */
#define RTE_OUTB_PDU_RECV_CNT(g)  __REG(TARGET_RTE,\
					0, 1, 0, g, 513, 64, 44, 0, 1, 4)
...
#define RTE_OUTB_DG_MISC_DG_ADDR(x)              (((x) << 16) & GENMASK(25, 16))
#define RTE_OUTB_DG_MISC_DG_ADDR_M               GENMASK(25, 16)
#define RTE_OUTB_DG_MISC_DG_ADDR_X(x)            (((x) & GENMASK(25, 16)) >> 16)
...
#define RTE_OUTB_DG_DATA_SECTION_ADDR_DG_DATA_SECTION_ADDR(x)\
	((x) & GENMASK(9, 0))
#define RTE_OUTB_DG_DATA_SECTION_ADDR_DG_DATA_SECTION_ADDR_M GENMASK(9, 0)
...
#define RTE_OUTB_WR_ACTION_ADDR(g) __REG(TARGET_RTE,\
					0, 1, 114688, g, 513, 16, 8, 0, 1, 4)

#define RTE_OUTB_WR_ACTION_ADDR_WR_ACTION_ADDR(x) ((x) & GENMASK(9, 0))
#define RTE_OUTB_WR_ACTION_ADDR_WR_ACTION_ADDR_M GENMASK(9, 0)
#define RTE_OUTB_WR_ACTION_ADDR_WR_ACTION_ADDR_X(x) ((x) & GENMASK(9, 0))

/*      RTE:OUTB_WR_ACTION_TBL:WR_ACTION_DG_DATA */
#define RTE_WR_ACTION_DG_DATA(g)  __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 0, 0, 1, 4)
...
#define RTE_WR_ACTION_DG_DATA_DG_DATA_SECTION_ADDR(x) ((x) & GENMASK(9, 0))
#define RTE_WR_ACTION_DG_DATA_DG_DATA_SECTION_ADDR_M GENMASK(9, 0)
#define RTE_WR_ACTION_DG_DATA_DG_DATA_SECTION_ADDR_X(x) ((x) & GENMASK(9, 0))

/*      RTE:OUTB_WR_ACTION_TBL:WR_ACTION_MISC */
#define RTE_WR_ACTION_MISC(g)     __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 4, 0, 1, 4)
...
#define RTE_WR_ACTION_MISC_WR_ACTION_ADDR(x)     (((x) << 12) & GENMASK(21, 12))
#define RTE_WR_ACTION_MISC_WR_ACTION_ADDR_M      GENMASK(21, 12)
#define RTE_WR_ACTION_MISC_WR_ACTION_ADDR_X(x)   (((x) & GENMASK(21, 12)) >> 12)

#define RTE_WR_ACTION_MISC_OUTB_RTP_ID(x)        ((x) & GENMASK(9, 0))
#define RTE_WR_ACTION_MISC_OUTB_RTP_ID_M         GENMASK(9, 0)
#define RTE_WR_ACTION_MISC_OUTB_RTP_ID_X(x)      ((x) & GENMASK(9, 0))

/*      RTE:OUTB_WR_ACTION_TBL:WR_RAI_ADDR */
#define RTE_WR_RAI_ADDR(g)        __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 8, 0, 1, 4)

/*      RTE:OUTB_WR_ACTION_TBL:WR_ACTION_RTP_GRP */
#define RTE_WR_ACTION_RTP_GRP(g)  __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 12, 0, 1, 4)
...
#define RTE_WR_ACTION_RTP_GRP_RTP_GRP_ID(x)      ((x) & GENMASK(8, 0))
#define RTE_WR_ACTION_RTP_GRP_RTP_GRP_ID_M       GENMASK(8, 0)
#define RTE_WR_ACTION_RTP_GRP_RTP_GRP_ID_X(x)    ((x) & GENMASK(8, 0))

/*      RTE:OUTB_WR_ACTION_TBL:RD_RAI_ADDR */
#define RTE_RD_RAI_ADDR(g)        __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 16, 0, 1, 4)

/*      RTE:OUTB_WR_ACTION_TBL:OFFSET_RAI_ADDR */
#define RTE_OFFSET_RAI_ADDR(g)    __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 20, 0, 1, 4)
...
#define RTE_BUF3_ADDR(g)          __REG(TARGET_RTE,\
					0, 1, 196608, g, 577, 32, 24, 0, 1, 4)

#define RTE_BUF3_ADDR_BUF3_ADDR(x)               ((x) & GENMASK(9, 0))
#define RTE_BUF3_ADDR_BUF3_ADDR_M                GENMASK(9, 0)
#define RTE_BUF3_ADDR_BUF3_ADDR_X(x)             ((x) & GENMASK(9, 0))

/*      RTE:OUTB_BUF3_MISC:OUTB_BUF3_MISC */
#define RTE_OUTB_BUF3_MISC        __REG(TARGET_RTE,\
					0, 1, 33792, 0, 1, 160, 0, 0, 1, 4)

#define RTE_OUTB_BUF3_MISC_BUF3_ADDR(x)          ((x) & GENMASK(9, 0))
#define RTE_OUTB_BUF3_MISC_BUF3_ADDR_M           GENMASK(9, 0)
#define RTE_OUTB_BUF3_MISC_BUF3_ADDR_X(x)        ((x) & GENMASK(9, 0))

/*      RTE:OUTB_BUF3_MISC:OUTB_BUF3_STICKY_BITS */
#define RTE_OUTB_BUF3_STICKY_BITS __REG(TARGET_RTE,\
					0, 1, 33792, 0, 1, 160, 4, 0, 1, 4)
...
#define RTE_INB_TIMER_CMD         __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 0, 0, 1, 4)

#define RTE_INB_TIMER_CMD_TIMER_IDX(x)           (((x) << 16) & GENMASK(25, 16))
#define RTE_INB_TIMER_CMD_TIMER_IDX_M            GENMASK(25, 16)
#define RTE_INB_TIMER_CMD_TIMER_IDX_X(x)         (((x) & GENMASK(25, 16)) >> 16)
...
#define RTE_INB_TIMER_HEAP_SIZE_RD_TIMER_HEAP_SIZE(x)\
	(((x) << 12) & GENMASK(21, 12))
#define RTE_INB_TIMER_HEAP_SIZE_RD_TIMER_HEAP_SIZE_M GENMASK(21, 12)
#define RTE_INB_TIMER_HEAP_SIZE_RD_TIMER_HEAP_SIZE_X(x)\
	(((x) & GENMASK(21, 12)) >> 12)

#define RTE_INB_TIMER_HEAP_SIZE_RTP_TIMER_HEAP_SIZE(x) ((x) & GENMASK(9, 0))
#define RTE_INB_TIMER_HEAP_SIZE_RTP_TIMER_HEAP_SIZE_M GENMASK(9, 0)
#define RTE_INB_TIMER_HEAP_SIZE_RTP_TIMER_HEAP_SIZE_X(x) ((x) & GENMASK(9, 0))

/*      RTE:INB_MISC:INB_RD_ACTION_CMD */
#define RTE_INB_RD_ACTION_CMD     __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 12, 0, 1, 4)

#define RTE_INB_RD_ACTION_CMD_RD_ACTION_ADDR(x)  (((x) << 8) & GENMASK(17, 8))
#define RTE_INB_RD_ACTION_CMD_RD_ACTION_ADDR_M   GENMASK(17, 8)
#define RTE_INB_RD_ACTION_CMD_RD_ACTION_ADDR_X(x) (((x) & GENMASK(17, 8)) >> 8)
...
#define RTE_INB_FRM_DATA_ADDR     __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 16, 0, 1, 4)

#define RTE_INB_FRM_DATA_ADDR_FRM_DATA_ADDR(x)   ((x) & GENMASK(10, 0))
#define RTE_INB_FRM_DATA_ADDR_FRM_DATA_ADDR_M    GENMASK(10, 0)
#define RTE_INB_FRM_DATA_ADDR_FRM_DATA_ADDR_X(x) ((x) & GENMASK(10, 0))

/*      RTE:INB_MISC:INB_FRM_DATA_WR_MASK */
#define RTE_INB_FRM_DATA_WR_MASK  __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 20, 0, 1, 4)

/*      RTE:INB_MISC:INB_FRM_DATA_CTRL_ACC */
#define RTE_INB_FRM_DATA_CTRL_ACC __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 24, 0, 1, 4)
...
#define RTE_INB_FRM_DATA_CTRL_ACC_FRM_DATA_CTRL_ADDR(x) ((x) & GENMASK(10, 0))
#define RTE_INB_FRM_DATA_CTRL_ACC_FRM_DATA_CTRL_ADDR_M GENMASK(10, 0)
#define RTE_INB_FRM_DATA_CTRL_ACC_FRM_DATA_CTRL_ADDR_X(x) ((x) & GENMASK(10, 0))

/*      RTE:INB_MISC:INB_FRM_DATA_CHG_ADDR */
#define RTE_INB_FRM_DATA_CHG_ADDR __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 28, 0, 1, 4)

#define RTE_INB_FRM_DATA_CHG_ADDR_FRM_DATA_CHG_ADDR(x) ((x) & GENMASK(10, 0))
#define RTE_INB_FRM_DATA_CHG_ADDR_FRM_DATA_CHG_ADDR_M GENMASK(10, 0)
#define RTE_INB_FRM_DATA_CHG_ADDR_FRM_DATA_CHG_ADDR_X(x) ((x) & GENMASK(10, 0))

/*      RTE:INB_MISC:INB_STICKY_BITS */
#define RTE_INB_STICKY_BITS       __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 32, 0, 1, 4)
...
#define RTE_INB_FRM_INJ_PORT_CTRL(r) __REG(TARGET_RTE,\
					0, 1, 33164, 0, 1, 112, 64, r, 8, 4)

#define RTE_INB_FRM_INJ_PORT_CTRL_FRM_OUT_MAX_RTP_ID(x)\
	(((x) << 16) & GENMASK(25, 16))
#define RTE_INB_FRM_INJ_PORT_CTRL_FRM_OUT_MAX_RTP_ID_M GENMASK(25, 16)
...
#define RTE_INB_RTP_MISC(g)       __REG(TARGET_RTE,\
					0, 1, 131072, g, 513, 64, 4, 0, 1, 4)

#define RTE_INB_RTP_MISC_RTP_GRP_ID(x)           (((x) << 8) & GENMASK(16, 8))
#define RTE_INB_RTP_MISC_RTP_GRP_ID_M            GENMASK(16, 8)
#define RTE_INB_RTP_MISC_RTP_GRP_ID_X(x)         (((x) & GENMASK(16, 8)) >> 8)
...
#define RTE_INB_RTP_ADDRS(g)      __REG(TARGET_RTE,\
					0, 1, 131072, g, 513, 64, 12, 0, 1, 4)

#define RTE_INB_RTP_ADDRS_REDUN_ADDR(x)          (((x) << 16) & GENMASK(23, 16))
#define RTE_INB_RTP_ADDRS_REDUN_ADDR_M           GENMASK(23, 16)
#define RTE_INB_RTP_ADDRS_REDUN_ADDR_X(x)        (((x) & GENMASK(23, 16)) >> 16)

#define RTE_INB_RTP_ADDRS_FRM_DATA_ADDR(x)       ((x) & GENMASK(10, 0))
#define RTE_INB_RTP_ADDRS_FRM_DATA_ADDR_M        GENMASK(10, 0)
#define RTE_INB_RTP_ADDRS_FRM_DATA_ADDR_X(x)     ((x) & GENMASK(10, 0))

/*      RTE:INB_RTP_TBL:INB_RTP_OPC */
#define RTE_INB_RTP_OPC(g)        __REG(TARGET_RTE,\
					0, 1, 131072, g, 513, 64, 16, 0, 1, 4)
...
#define RTE_INB_RD_ACTION_ADDR(g) __REG(TARGET_RTE,\
					0, 1, 180224, g, 513, 16, 8, 0, 1, 4)

#define RTE_INB_RD_ACTION_ADDR_RD_ACTION_ADDR(x) ((x) & GENMASK(9, 0))
#define RTE_INB_RD_ACTION_ADDR_RD_ACTION_ADDR_M  GENMASK(9, 0)
#define RTE_INB_RD_ACTION_ADDR_RD_ACTION_ADDR_X(x) ((x) & GENMASK(9, 0))

/*      RTE:INB_RD_ACTION_TBL:INB_BASE_RAI_ADDR */
#define RTE_INB_BASE_RAI_ADDR(g)  __REG(TARGET_RTE,\
					0, 1, 229376, g, 577, 32, 0, 0, 1, 4)

/*      RTE:INB_RD_ACTION_TBL:INB_OFFSET_RAI_ADDR */
#define RTE_INB_OFFSET_RAI_ADDR(g) __REG(TARGET_RTE,\
					0, 1, 229376, g, 577, 32, 4, 0, 1, 4)
...
#define RTE_INB_RD_ACTION_BUF3_BUF3_ADDR(x)      ((x) & GENMASK(9, 0))
#define RTE_INB_RD_ACTION_BUF3_BUF3_ADDR_M       GENMASK(9, 0)
#define RTE_INB_RD_ACTION_BUF3_BUF3_ADDR_X(x)    ((x) & GENMASK(9, 0))

/*      RTE:INB_RD_ACTION_TBL:INB_RD_ACTION_MISC */
#define RTE_INB_RD_ACTION_MISC(g) __REG(TARGET_RTE,\
					0, 1, 229376, g, 577, 32, 16, 0, 1, 4)
...
#define RTE_INB_RD_ACTION_ADDRS(g) __REG(TARGET_RTE,\
					0, 1, 229376, g, 577, 32, 20, 0, 1, 4)

#define RTE_INB_RD_ACTION_ADDRS_RD_ACTION_ADDR(x)\
	(((x) << 16) & GENMASK(25, 16))
#define RTE_INB_RD_ACTION_ADDRS_RD_ACTION_ADDR_M GENMASK(25, 16)
#define RTE_INB_RD_ACTION_ADDRS_RD_ACTION_ADDR_X(x)\
	(((x) & GENMASK(25, 16)) >> 16)

#define RTE_INB_RD_ACTION_ADDRS_FRM_DATA_CP_ADDR(x) ((x) & GENMASK(9, 0))
#define RTE_INB_RD_ACTION_ADDRS_FRM_DATA_CP_ADDR_M GENMASK(9, 0)
#define RTE_INB_RD_ACTION_ADDRS_FRM_DATA_CP_ADDR_X(x) ((x) & GENMASK(9, 0))

/*      RTE:INB_RD_ACTION_TBL:INB_RD_ACTION_STICKY_BITS */
#define RTE_INB_RD_ACTION_STICKY_BITS(g) __REG(TARGET_RTE,\
					0, 1, 229376, g, 577, 32, 24, 0, 1, 4)
...
#define RTE_INB_BUF3_MISC         __REG(TARGET_RTE,\
					0, 1, 33952, 0, 1, 160, 0, 0, 1, 4)

#define RTE_INB_BUF3_MISC_BUF3_ADDR(x)           ((x) & GENMASK(9, 0))
#define RTE_INB_BUF3_MISC_BUF3_ADDR_M            GENMASK(9, 0)
#define RTE_INB_BUF3_MISC_BUF3_ADDR_X(x)         ((x) & GENMASK(9, 0))

/*      RTE:INB_BUF3_MISC:INB_BUF3_STICKY_BITS */
#define RTE_INB_BUF3_STICKY_BITS  __REG(TARGET_RTE,\
					0, 1, 33952, 0, 1, 160, 4, 0, 1, 4)
...
#define RTE_INB_FRM_DATA_CP_ADDRS(g) __REG(TARGET_RTE,\
					0, 1, 262144, g, 513, 32, 0, 0, 1, 4)

#define RTE_INB_FRM_DATA_CP_ADDRS_FRM_DATA_CTRL_ADDR(x)\
	(((x) << 16) & GENMASK(26, 16))
#define RTE_INB_FRM_DATA_CP_ADDRS_FRM_DATA_CTRL_ADDR_M GENMASK(26, 16)
#define RTE_INB_FRM_DATA_CP_ADDRS_FRM_DATA_CTRL_ADDR_X(x)\
	(((x) & GENMASK(26, 16)) >> 16)

#define RTE_INB_FRM_DATA_CP_ADDRS_FRM_DATA_CP_ADDR(x) ((x) & GENMASK(9, 0))
#define RTE_INB_FRM_DATA_CP_ADDRS_FRM_DATA_CP_ADDR_M GENMASK(9, 0)
#define RTE_INB_FRM_DATA_CP_ADDRS_FRM_DATA_CP_ADDR_X(x) ((x) & GENMASK(9, 0))

/*      RTE:INB_FRM_DATA_CP_TBL:INB_FRM_DATA_BYTE_ADDR1 */
#define RTE_INB_FRM_DATA_BYTE_ADDR1(g) __REG(TARGET_RTE,\
					0, 1, 262144, g, 513, 32, 4, 0, 1, 4)

#define RTE_INB_FRM_DATA_BYTE_ADDR1_DG_VLD_FRM_DATA_BYTE_ADDR(x)\
	(((x) << 16) & GENMASK(31, 16))
#define RTE_INB_FRM_DATA_BYTE_ADDR1_DG_VLD_FRM_DATA_BYTE_ADDR_M GENMASK(31, 16)
...
#define RTE_INB_FRM_DATA_BYTE_ADDR1_DG_FRM_DATA_BYTE_ADDR(x)\
	((x) & GENMASK(15, 0))
#define RTE_INB_FRM_DATA_BYTE_ADDR1_DG_FRM_DATA_BYTE_ADDR_M GENMASK(15, 0)
