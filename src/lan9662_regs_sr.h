...
/*
 * This file is autogenerated by cml-utils 2020-06-03 09:20:49 +0000.
 * Commit ID: 6cc144b5f26939d939c37d1bf1c4fca16cf853f7
 */

#ifndef _LAN9662_REGS_SR_H_
#define _LAN9662_REGS_SR_H_

#define GENMASK(h, l) VTSS_ENCODE_BITMASK(l, (h) - (l) + 1)

#define LAN966X_BUILD_ID_REG CPU_BUILDID
#define LAN966X_BUILD_ID 1590497112
...
#define LAN966X_TARGET_DEVCPU_ORG_0_OFFSET 0x00000000
#define LAN966X_TARGET_DEVCPU_ORG_0_REGION REGION_DEFAULT

#define LAN966X_TARGET_DEVCPU_ORG_1_OFFSET 0x00400000
#define LAN966X_TARGET_DEVCPU_ORG_1_REGION REGION_DEFAULT
...
#define LAN966X_TARGET_DWC_USB3_HOST_OFFSET 0x00300000
#define LAN966X_TARGET_DWC_USB3_HOST_REGION REGION_AMBA_AXI_TOP
...
#define CPU_BUILDID               TARGET_CPU,0,1,0,0,1,168,128,0,1,4

/*      GCB:CHIP_REGS:BUILDID */
#define GCB_BUILDID               TARGET_GCB,0,1,0,0,1,80,76,0,1,4

/*      RTE:MISC:RTE_CFG */
#define RTE_RTE_CFG               TARGET_RTE,0,1,9344,0,1,36,0,0,1,4
...
/*      RTE:MISC:RUT */
#define RTE_RUT                   TARGET_RTE,0,1,9344,0,1,36,4,0,1,4
...
/*      RTE:MISC:SC_LEN */
#define RTE_SC_LEN                TARGET_RTE,0,1,9344,0,1,36,8,0,1,4
...
/*      RTE:MISC:SC_TIME */
#define RTE_SC_TIME               TARGET_RTE,0,1,9344,0,1,36,12,0,1,4
...
/*      RTE:MISC:TSE_PULSE */
#define RTE_TSE_PULSE             TARGET_RTE,0,1,9344,0,1,36,16,0,1,4
...
/*      RTE:MISC:PN_MISC */
#define RTE_PN_MISC               TARGET_RTE,0,1,9344,0,1,36,20,0,1,4
...
/*      RTE:MISC:SC_RESET */
#define RTE_SC_RESET              TARGET_RTE,0,1,9344,0,1,36,24,0,1,4
...
/*      RTE:MISC:PN_CC_MISC */
#define RTE_PN_CC_MISC            TARGET_RTE,0,1,9344,0,1,36,28,0,1,4
...
/*      RTE:MISC:TIME_MISC */
#define RTE_TIME_MISC             TARGET_RTE,0,1,9344,0,1,36,32,0,1,4
...
#define RTE_RTP_GRP_STATE         TARGET_RTE,0,1,7408,0,1,4,0,0,1,4

/*      RTE:OUTB_MISC:OUTB_CFG */
#define RTE_OUTB_CFG              TARGET_RTE,0,1,9380,0,1,76,0,0,1,4
...
#define RTE_OUTB_TIMER_CMD        TARGET_RTE,0,1,9380,0,1,76,4,0,1,4
...
#define RTE_OUTB_TIMER_STICKY_BITS TARGET_RTE,0,1,9380,0,1,76,8,0,1,4
...
#define RTE_OUTB_TIMER_HEAP_SIZE  TARGET_RTE,0,1,9380,0,1,76,12,0,1,4
...
#define RTE_OUTB_WR_ACTION_CMD    TARGET_RTE,0,1,9380,0,1,76,16,0,1,4
...
#define RTE_OUTB_BUS_ERROR        TARGET_RTE,0,1,9380,0,1,76,20,0,1,4

/*      RTE:OUTB_MISC:OUTB_DG_DATA_ADDR */
#define RTE_OUTB_DG_DATA_ADDR     TARGET_RTE,0,1,9380,0,1,76,24,0,1,4
...
#define RTE_OUTB_LAST_VLD_DG_DATA_ADDR TARGET_RTE,0,1,9380,0,1,76,28,0,1,4
...
#define RTE_OUTB_DG_DATA_RTP_CTRL_ACC TARGET_RTE,0,1,9380,0,1,76,32,0,1,4
...
#define RTE_OUTB_STICKY_BITS_RTP_STATE_STOPPED_STICKY(x)\
	(((x) << 11) & GENMASK(11, 11))
#define RTE_OUTB_STICKY_BITS_RTP_STATE_STOPPED_STICKY_M GENMASK(11, 11)
#define RTE_OUTB_STICKY_BITS_RTP_STATE_STOPPED_STICKY_X(x)\
	(((x) & GENMASK(11, 11)) >> 11)

#define RTE_OUTB_STICKY_BITS_PDU_LEN_WRONG_STICKY(x)\
	(((x) << 10) & GENMASK(10, 10))
#define RTE_OUTB_STICKY_BITS_PDU_LEN_WRONG_STICKY_M GENMASK(10, 10)
#define RTE_OUTB_STICKY_BITS_PDU_LEN_WRONG_STICKY_X(x)\
	(((x) & GENMASK(10, 10)) >> 10)

#define RTE_OUTB_STICKY_BITS_PN_CC_MISMATCH_STICKY(x)\
	(((x) << 9) & GENMASK(9, 9))
#define RTE_OUTB_STICKY_BITS_PN_CC_MISMATCH_STICKY_M GENMASK(9, 9)
#define RTE_OUTB_STICKY_BITS_PN_CC_MISMATCH_STICKY_X(x)\
	(((x) & GENMASK(9, 9)) >> 9)

#define RTE_OUTB_STICKY_BITS_PN_DATA_STATUS_MISMATCH_STICKY(x)\
	(((x) << 8) & GENMASK(8, 8))
#define RTE_OUTB_STICKY_BITS_PN_DATA_STATUS_MISMATCH_STICKY_M GENMASK(8, 8)
#define RTE_OUTB_STICKY_BITS_PN_DATA_STATUS_MISMATCH_STICKY_X(x)\
	(((x) & GENMASK(8, 8)) >> 8)

#define RTE_OUTB_STICKY_BITS_DG_NOT_VLD_STICKY(x) (((x) << 7) & GENMASK(7, 7))
#define RTE_OUTB_STICKY_BITS_DG_NOT_VLD_STICKY_M GENMASK(7, 7)
#define RTE_OUTB_STICKY_BITS_DG_NOT_VLD_STICKY_X(x) (((x) & GENMASK(7, 7)) >> 7)

#define RTE_OUTB_STICKY_BITS_FRM_RX_RTP_GRP_STATE_STOPPED_STICKY(x)\
	(((x) << 6) & GENMASK(6, 6))
#define RTE_OUTB_STICKY_BITS_FRM_RX_RTP_GRP_STATE_STOPPED_STICKY_M GENMASK(6, 6)
...
#define RTE_OUTB_STICKY_BITS_FRM_RX_RTP_STATE_STOPPED_STICKY(x)\
	(((x) << 5) & GENMASK(5, 5))
#define RTE_OUTB_STICKY_BITS_FRM_RX_RTP_STATE_STOPPED_STICKY_M GENMASK(5, 5)
...
#define RTE_OUTB_STICKY_BITS_WR_ACTION_FIFO_OFLW_STICKY(x)\
	(((x) << 3) & GENMASK(3, 3))
#define RTE_OUTB_STICKY_BITS_WR_ACTION_FIFO_OFLW_STICKY_M GENMASK(3, 3)
#define RTE_OUTB_STICKY_BITS_WR_ACTION_FIFO_OFLW_STICKY_X(x)\
	(((x) & GENMASK(3, 3)) >> 3)

#define RTE_OUTB_STICKY_BITS_WR_ACTION_FIFO_FULL_STICKY(x)\
	(((x) << 2) & GENMASK(2, 2))
#define RTE_OUTB_STICKY_BITS_WR_ACTION_FIFO_FULL_STICKY_M GENMASK(2, 2)
#define RTE_OUTB_STICKY_BITS_WR_ACTION_FIFO_FULL_STICKY_X(x)\
	(((x) & GENMASK(2, 2)) >> 2)

#define RTE_OUTB_STICKY_BITS_WR_ACTION_BUS_ERROR_STICKY(x)\
	(((x) << 1) & GENMASK(1, 1))
#define RTE_OUTB_STICKY_BITS_WR_ACTION_BUS_ERROR_STICKY_M GENMASK(1, 1)
#define RTE_OUTB_STICKY_BITS_WR_ACTION_BUS_ERROR_STICKY_X(x)\
	(((x) & GENMASK(1, 1)) >> 1)

#define RTE_OUTB_STICKY_BITS_WR_TIMER_OLD_STICKY(x) ((x) & GENMASK(0, 0))
#define RTE_OUTB_STICKY_BITS_WR_TIMER_OLD_STICKY_M GENMASK(0, 0)
#define RTE_OUTB_STICKY_BITS_WR_TIMER_OLD_STICKY_X(x) ((x) & GENMASK(0, 0))

/*      RTE:OUTB_MISC:OUTB_STICKY_BITS_IRQ_MASK */
#define RTE_OUTB_STICKY_BITS_IRQ_MASK TARGET_RTE,0,1,9380,0,1,76,40,0,1,4

/*      RTE:OUTB_MISC:OUTB_FRM_FWD */
#define RTE_OUTB_FRM_FWD          TARGET_RTE,0,1,9380,0,1,76,44,0,1,4
...
#define RTE_OUTB_PN_PDU_MISC      TARGET_RTE,0,1,9380,0,1,76,48,0,1,4
...
#define RTE_OUTB_OPC_PDU_FLAGS    TARGET_RTE,0,1,9380,0,1,76,52,0,1,4
...
#define RTE_OUTB_OPC_PDU_MISC     TARGET_RTE,0,1,9380,0,1,76,56,0,1,4
...
#define RTE_OUTB_PN_DG_MASKS      TARGET_RTE,0,1,9380,0,1,76,60,0,1,4
...
#define RTE_OUTB_OPC_DG_MASKS     TARGET_RTE,0,1,9380,0,1,76,64,0,1,4
...
#define RTE_OUTB_RTP_STATE        TARGET_RTE,0,1,9380,0,1,76,68,0,1,4

/*      RTE:OUTB_MISC:OUTB_DG_DATA_VLD_ACC */
#define RTE_OUTB_DG_DATA_VLD_ACC  TARGET_RTE,0,1,9380,0,1,76,72,0,1,4
...
#define RTE_OUTB_DG_DATA          TARGET_RTE,0,1,7384,0,1,4,0,0,1,4

/*      RTE:OUTB_LAST_VLD_DG_DATA:OUTB_LAST_VLD_DG_DATA */
#define RTE_OUTB_LAST_VLD_DG_DATA TARGET_RTE,0,1,7388,0,1,4,0,0,1,4

/*      RTE:OUTB_DG_DATA_VLD:OUTB_DG_DATA_VLD */
#define RTE_OUTB_DG_DATA_VLD      TARGET_RTE,0,1,7360,0,1,16,0,0,1,4

/*      RTE:OUTB_DG_DATA_VLD:OUTB_DG_DATA_VLD_CLR */
#define RTE_OUTB_DG_DATA_VLD_CLR  TARGET_RTE,0,1,7360,0,1,16,4,0,1,4

/*      RTE:OUTB_DG_DATA_VLD:OUTB_DG_DATA_VLD_SET */
#define RTE_OUTB_DG_DATA_VLD_SET  TARGET_RTE,0,1,7360,0,1,16,8,0,1,4

/*      RTE:OUTB_RTP_TBL:OUTB_RTP_STICKY_BITS */
#define RTE_OUTB_RTP_STICKY_BITS(g) TARGET_RTE,0,1,0,g,32,64,0,0,1,4
...
#define RTE_OUTB_RTP_MISC(g)      TARGET_RTE,0,1,0,g,32,64,4,0,1,4
...
#define RTE_OUTB_RTP_PDU_CHKS(g)  TARGET_RTE,0,1,0,g,32,64,8,0,1,4
...
#define RTE_OUTB_RTP_PN_MISC(g)   TARGET_RTE,0,1,0,g,32,64,12,0,1,4
...
#define RTE_OUTB_RTP_OPC_GRP_VER(g) TARGET_RTE,0,1,0,g,32,64,16,0,1,4

/*      RTE:OUTB_RTP_TBL:OUTB_RTP_TIMER_CFG1 */
#define RTE_OUTB_RTP_TIMER_CFG1(g) TARGET_RTE,0,1,0,g,32,64,20,0,1,4
...
#define RTE_OUTB_RTP_TIMER_CFG2(g) TARGET_RTE,0,1,0,g,32,64,24,0,1,4
...
#define RTE_OUTB_RTP_TIMER_CFG3(g) TARGET_RTE,0,1,0,g,32,64,28,0,1,4
...
#define RTE_OUTB_DG_ADDR(g,r)     TARGET_RTE,0,1,0,g,32,64,32,r,3,4
...
#define RTE_OUTB_PDU_RECV_CNT(g)  TARGET_RTE,0,1,0,g,32,64,44,0,1,4
...
#define RTE_OUTB_DG_DATA_RTP_CTRL TARGET_RTE,0,1,7392,0,1,4,0,0,1,4
...
#define RTE_OUTB_DG_MISC(g)       TARGET_RTE,0,1,2048,g,32,64,0,0,1,4
...
#define RTE_OUTB_DG_DATA_OFFSET_PDU_POS(g) TARGET_RTE,0,1,2048,g,32,64,4,0,1,4
...
#define RTE_OUTB_DG_DATA_SECTION_ADDR(g) TARGET_RTE,0,1,2048,g,32,64,8,0,1,4
...
#define RTE_OUTB_PN_IOPS(g)       TARGET_RTE,0,1,2048,g,32,64,12,0,1,4
...
#define RTE_OUTB_OPC_DATA_SET_FLAGS1_VAL(g) TARGET_RTE,0,1,2048,g,32,64,16,0,1,4
...
#define RTE_OUTB_OPC_DATA_SET_FLAGS1_MISC(g) TARGET_RTE,0,1,2048,g,32,64,20,0,1,4
...
#define RTE_OUTB_OPC_SEQ_NUM(g)   TARGET_RTE,0,1,2048,g,32,64,24,0,1,4
...
#define RTE_OUTB_OPC_STATUS_CODE_VAL(g) TARGET_RTE,0,1,2048,g,32,64,28,0,1,4
...
#define RTE_OUTB_OPC_STATUS_CODE_MISC(g) TARGET_RTE,0,1,2048,g,32,64,32,0,1,4
...
#define RTE_OUTB_DG_STICKY_BITS(g) TARGET_RTE,0,1,9728,g,32,16,0,0,1,4
...
#define RTE_OUTB_PN_STATUS(g)     TARGET_RTE,0,1,9728,g,32,16,4,0,1,4
...
#define RTE_OUTB_OPC_STATUS(g)    TARGET_RTE,0,1,9728,g,32,16,8,0,1,4
...
#define RTE_OUTB_OPC_STATUS2(g)   TARGET_RTE,0,1,9728,g,32,16,12,0,1,4
...
#define RTE_OUTB_WR_TIMER_CFG1(g) TARGET_RTE,0,1,11264,g,32,16,0,0,1,4
...
#define RTE_OUTB_WR_TIMER_CFG2(g) TARGET_RTE,0,1,11264,g,32,16,4,0,1,4
...
#define RTE_OUTB_WR_ACTION_ADDR(g) TARGET_RTE,0,1,11264,g,32,16,8,0,1,4
...
#define RTE_WR_ACTION_DG_DATA(g)  TARGET_RTE,0,1,6144,g,36,32,0,0,1,4
...
#define RTE_WR_ACTION_MISC(g)     TARGET_RTE,0,1,6144,g,36,32,4,0,1,4
...
#define RTE_WR_ACTION_MISC_BUF3_WR_MODE(x)       (((x) << 25) & GENMASK(26, 25))
#define RTE_WR_ACTION_MISC_BUF3_WR_MODE_M        GENMASK(26, 25)
#define RTE_WR_ACTION_MISC_BUF3_WR_MODE_X(x)     (((x) & GENMASK(26, 25)) >> 25)

#define RTE_WR_ACTION_MISC_HW_WR_DIS_MODE(x)     (((x) << 27) & GENMASK(28, 27))
#define RTE_WR_ACTION_MISC_HW_WR_DIS_MODE_M      GENMASK(28, 27)
#define RTE_WR_ACTION_MISC_HW_WR_DIS_MODE_X(x)   (((x) & GENMASK(28, 27)) >> 27)

#define RTE_WR_ACTION_MISC_INTERN_ENA(x)         (((x) << 29) & GENMASK(29, 29))
#define RTE_WR_ACTION_MISC_INTERN_ENA_M          GENMASK(29, 29)
#define RTE_WR_ACTION_MISC_INTERN_ENA_X(x)       (((x) & GENMASK(29, 29)) >> 29)

#define RTE_WR_ACTION_MISC_TRANSFER_PROTECT_ENA(x)\
	(((x) << 30) & GENMASK(30, 30))
#define RTE_WR_ACTION_MISC_TRANSFER_PROTECT_ENA_M GENMASK(30, 30)
#define RTE_WR_ACTION_MISC_TRANSFER_PROTECT_ENA_X(x)\
	(((x) & GENMASK(30, 30)) >> 30)

#define RTE_WR_ACTION_MISC_RTP_STOPPED_MODE(x)   (((x) << 31) & GENMASK(31, 31))
#define RTE_WR_ACTION_MISC_RTP_STOPPED_MODE_M    GENMASK(31, 31)
#define RTE_WR_ACTION_MISC_RTP_STOPPED_MODE_X(x) (((x) & GENMASK(31, 31)) >> 31)
...
#define RTE_WR_ACTION_RTP_GRP(g)  TARGET_RTE,0,1,6144,g,36,32,12,0,1,4
...
#define RTE_OUTB_BUF3_MISC        TARGET_RTE,0,1,9616,0,1,24,0,0,1,4
...
#define RTE_OUTB_BUF3_STICKY_BITS TARGET_RTE,0,1,9616,0,1,24,4,0,1,4
...
#define RTE_OUTB_BUF3_STATE(r)    TARGET_RTE,0,1,9616,0,1,24,8,r,2,4

/*      RTE:OUTB_BUF3_MISC:OUTB_BUF3_STATE_IRQ_MASK */
#define RTE_OUTB_BUF3_STATE_IRQ_MASK(r) TARGET_RTE,0,1,9616,0,1,24,16,r,2,4

/*      RTE:OUTB_BUF3_TBL:OUTB_BUF3 */
#define RTE_OUTB_BUF3             TARGET_RTE,0,1,7396,0,1,4,0,0,1,4
...
#define RTE_OUTB_BUF3_RD_REQ(g)   TARGET_RTE,0,1,9472,g,36,4,0,0,1,4
...
#define RTE_OUTB_BUF3_RD_REL(g)   TARGET_RTE,0,1,12288,g,36,4,0,0,1,4
...
#define RTE_INB_TIMER_CMD         TARGET_RTE,0,1,12432,0,1,104,0,0,1,4
...
#define RTE_INB_TIMER_STICKY_BITS TARGET_RTE,0,1,12432,0,1,104,4,0,1,4
...
#define RTE_INB_TIMER_HEAP_SIZE   TARGET_RTE,0,1,12432,0,1,104,8,0,1,4
...
#define RTE_INB_RD_ACTION_CMD     TARGET_RTE,0,1,12432,0,1,104,12,0,1,4
...
#define RTE_INB_FRM_DATA_ADDR     TARGET_RTE,0,1,12432,0,1,104,16,0,1,4
...
#define RTE_INB_FRM_DATA_WR_MASK  TARGET_RTE,0,1,12432,0,1,104,20,0,1,4

/*      RTE:INB_MISC:INB_FRM_DATA_CTRL_ACC */
#define RTE_INB_FRM_DATA_CTRL_ACC TARGET_RTE,0,1,12432,0,1,104,24,0,1,4
...
#define RTE_INB_FRM_DATA_CHG_ADDR TARGET_RTE,0,1,12432,0,1,104,28,0,1,4
...
#define RTE_INB_STICKY_BITS       TARGET_RTE,0,1,12432,0,1,104,32,0,1,4
...
#define RTE_INB_STICKY_BITS_RD_ACTION_RD_SLAVE_ERR_STICKY(x)\
	(((x) << 7) & GENMASK(7, 7))
#define RTE_INB_STICKY_BITS_RD_ACTION_RD_SLAVE_ERR_STICKY_M GENMASK(7, 7)
#define RTE_INB_STICKY_BITS_RD_ACTION_RD_SLAVE_ERR_STICKY_X(x)\
	(((x) & GENMASK(7, 7)) >> 7)
...
#define RTE_INB_STICKY_BITS_IRQ_MASK TARGET_RTE,0,1,12432,0,1,104,36,0,1,4

/*      RTE:INB_MISC:INB_CFG */
#define RTE_INB_CFG               TARGET_RTE,0,1,12432,0,1,104,40,0,1,4
...
#define RTE_INB_CNT               TARGET_RTE,0,1,12432,0,1,104,44,0,1,4
...
#define RTE_INB_DG_VLD_CLR_SET    TARGET_RTE,0,1,12432,0,1,104,48,0,1,4
...
#define RTE_INB_DG_VLD_ERR        TARGET_RTE,0,1,12432,0,1,104,52,0,1,4
...
#define RTE_INB_DG_STATUS_CLR_SET TARGET_RTE,0,1,12432,0,1,104,56,0,1,4
...
#define RTE_INB_DG_STATUS_ERR     TARGET_RTE,0,1,12432,0,1,104,60,0,1,4
...
#define RTE_INB_FRM_INJ_PORT_CTRL(r) TARGET_RTE,0,1,12432,0,1,104,64,r,8,4
...
#define RTE_INB_RD_ACTION_DBG     TARGET_RTE,0,1,12432,0,1,104,96,0,1,4

#define RTE_INB_RD_ACTION_DBG_RD_ACTION_STATE_STICKY(x) ((x) & GENMASK(11, 0))
#define RTE_INB_RD_ACTION_DBG_RD_ACTION_STATE_STICKY_M GENMASK(11, 0)
#define RTE_INB_RD_ACTION_DBG_RD_ACTION_STATE_STICKY_X(x) ((x) & GENMASK(11, 0))

/*      RTE:INB_MISC:INB_FRM_DATA_CP_DBG */
#define RTE_INB_FRM_DATA_CP_DBG   TARGET_RTE,0,1,12432,0,1,104,100,0,1,4
...
#define RTE_INB_FRM_DATA(g,r)     TARGET_RTE,0,1,7296,g,2,32,0,r,8,4
...
#define RTE_INB_FRM_DATA_CTRL     TARGET_RTE,0,1,7400,0,1,4,0,0,1,4
...
#define RTE_INB_FRM_DATA_CHG_BYTE TARGET_RTE,0,1,7376,0,1,8,0,0,1,4

/*      RTE:INB_FRM_DATA_CHG:INB_FRM_DATA_OPC_DG_SEQ_NUM_BYTE_POS */
#define RTE_INB_FRM_DATA_OPC_DG_SEQ_NUM_BYTE_POS TARGET_RTE,0,1,7376,0,1,8,4,0,1,4
...
#define RTE_INB_RD_TIMER_CFG1(g)  TARGET_RTE,0,1,11776,g,32,16,0,0,1,4
...
#define RTE_INB_RD_TIMER_CFG2(g)  TARGET_RTE,0,1,11776,g,32,16,4,0,1,4
...
#define RTE_INB_RD_ACTION_ADDR(g) TARGET_RTE,0,1,11776,g,32,16,8,0,1,4
...
#define RTE_INB_BASE_RAI_ADDR(g)  TARGET_RTE,0,1,8192,g,36,32,0,0,1,4

/*      RTE:INB_RD_ACTION_TBL:INB_OFFSET_RAI_ADDR */
#define RTE_INB_OFFSET_RAI_ADDR(g) TARGET_RTE,0,1,8192,g,36,32,4,0,1,4
...
#define RTE_INB_WR_RAI_ADDR(g)    TARGET_RTE,0,1,8192,g,36,32,8,0,1,4

/*      RTE:INB_RD_ACTION_TBL:INB_RD_ACTION_BUF3 */
#define RTE_INB_RD_ACTION_BUF3(g) TARGET_RTE,0,1,8192,g,36,32,12,0,1,4
...
#define RTE_INB_RD_ACTION_MISC(g) TARGET_RTE,0,1,8192,g,36,32,16,0,1,4
...
#define RTE_INB_RD_ACTION_ADDRS(g) TARGET_RTE,0,1,8192,g,36,32,20,0,1,4
...
#define RTE_INB_RD_ACTION_STICKY_BITS(g) TARGET_RTE,0,1,8192,g,36,32,24,0,1,4
...
#define RTE_INB_RD_ACTION_STICKY_BITS_RD_ACTION_RD_SLAVE_ERR_STICKY(x)\
	(((x) << 3) & GENMASK(3, 3))
#define RTE_INB_RD_ACTION_STICKY_BITS_RD_ACTION_RD_SLAVE_ERR_STICKY_M\
	GENMASK(3, 3)
#define RTE_INB_RD_ACTION_STICKY_BITS_RD_ACTION_RD_SLAVE_ERR_STICKY_X(x)\
	(((x) & GENMASK(3, 3)) >> 3)
...
#define RTE_INB_BUF3_MISC         TARGET_RTE,0,1,9640,0,1,24,0,0,1,4
...
#define RTE_INB_BUF3_STICKY_BITS  TARGET_RTE,0,1,9640,0,1,24,4,0,1,4
...
#define RTE_INB_BUF3_STATE(r)     TARGET_RTE,0,1,9640,0,1,24,8,r,2,4

/*      RTE:INB_BUF3_MISC:INB_BUF3_STATE_IRQ_MASK */
#define RTE_INB_BUF3_STATE_IRQ_MASK(r) TARGET_RTE,0,1,9640,0,1,24,16,r,2,4

/*      RTE:INB_BUF3_TBL:INB_BUF3 */
#define RTE_INB_BUF3              TARGET_RTE,0,1,7404,0,1,4,0,0,1,4
...
#define RTE_INB_BUF3_WR_REQ(g)    TARGET_RTE,0,1,12544,g,36,4,0,0,1,4
...
#define RTE_INB_BUF3_WR_REL(g)    TARGET_RTE,0,1,12800,g,36,4,0,0,1,4
...
#define RTE_INB_FRM_DATA_CP_ADDRS(g) TARGET_RTE,0,1,10240,g,32,32,0,0,1,4
...
#define RTE_INB_FRM_DATA_BYTE_ADDR1(g) TARGET_RTE,0,1,10240,g,32,32,4,0,1,4
...
#define RTE_INB_FRM_DATA_BYTE_ADDR2(g) TARGET_RTE,0,1,10240,g,32,32,8,0,1,4
...
#define RTE_INB_FRM_DATA_CP_MISC(g) TARGET_RTE,0,1,10240,g,32,32,12,0,1,4
...
#define RTE_INB_FRM_DATA_CP_STICKY_BITS(g) TARGET_RTE,0,1,10240,g,32,32,16,0,1,4
